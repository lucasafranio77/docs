    ...
    return (
      <html lang="en">
        <head>
          ...
          <link rel="shortcut icon" type="image/x-icon" href="docs/src/img/favicon.ico" />
          ...
          <link rel="apple-touch-icon" sizes="180x180" href="docs/src/img/apple-touch-icon.png" />
          <link rel="icon" type="image/png" sizes="192x192" href="docs/src/img/android-chrome-192x192.png" />
          <link rel="icon" type="image/png" sizes="32x32" href="docs/src/img/favicon-32x32.png" />
          {/*<link rel="icon" type="image/png" sizes="96x96" href="https://sendgrid.com/brand/favicons/favicon-96x96.png" />*/}
          <link rel="icon" type="image/png" sizes="16x16" href="docs/src/img/favicon-16x16.png" />
          <link rel="manifest" href="docs/src/img/manifest.json" />
          <meta name="msapplication-TileColor" content="#ffffff" />
          <meta name="msapplication-TileImage" content="docs/src/img/mstile-150x150.png" />
